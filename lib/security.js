...
export const EMAIL_AFILIADOS =
  (typeof process !== "undefined" && process.env.NEXT_PUBLIC_EMAIL_AFILIADOS) ||
  "afiliados.crm@gmail.com";

export const EMAILS_PERMITIDOS = [EMAIL_HONDA, EMAIL_AFILIADOS];
...
export function crmDoEmail(email) {
  ...
  if (limpo === EMAIL_AFILIADOS) return "afiliados";
  return "";
}
