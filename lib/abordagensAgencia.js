...
const VARIANTES = [
  (ola) => [
    ...
    "Prazer, sou Alessandro, da Web Media.",
...
/** Temporário: pausa entre balões do mesmo chat (~8–15s) para o WhatsApp não restringir. */
export function delayEntreBaloesMs() {
  return 8 * 1000 + Math.floor(Math.random() * 7 * 1000);
}
